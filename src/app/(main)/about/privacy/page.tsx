  ...
  return (
    <>
      <div className="flex flex-col gap-2">
        ...
        <PageSubTitle>Who we are</PageSubTitle>
        <p>Our website address is: .</p>
        <p>
          {
            "Menime doesn't host any content on it own server and just linking to or embedding content that was uploaded to popular Online Video hosting sites like dailymotion.com, Youtube.com, Google Drive, ZShare.net, cloudy, netu.tv and such sites."
          }
        </p>
        <p>
          All trademarks, Videos, trade names, service marks, copyrighted work, logos referenced herein belong to their
          respective owners/companies. Menime is not responsible for what other people upload to 3rd party sites. We
          urge all copyright owners, to recognize that the links contained within this site are located somewhere else
          on the web or video embedded are from other various site like included above!.
        </p>
        <p>
          If you have any legal issues please contact appropriate media file owners / hosters. This privacy policy is
          intended to inform you about the types of information gathered by us when you visit Menime.
        </p>
        <PageSubTitle>Interpretation and Definitions</PageSubTitle>
        <PageSuperSubTitle>Interpretation</PageSuperSubTitle>
        <p>
        ...
        <PageSuperSubTitle>Definitions</PageSuperSubTitle>
        ...
        <UList>
          ...
          <li>
            <p>
              ...
              &quot;Our&quot; in this Privacy Policy) refers to Menime.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Personal Data</strong> (or &quot;Personal Information&quot;) is any information that relates to an
              identified or identifiable individual.
            </p>
            <p>
              We use &quot;Personal Data&quot; and &quot;Personal Information&quot; interchangeably unless a law uses a
              specific term.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Menime, accessible from{" "}
              <a href="https://menime.vercel.app/" rel="external nofollow noopener" target="_blank">
                https://menime.vercel.app/
              </a>
              .
            </p>
          </li>
        ...
        <PageSubTitle>Collecting and Using Your Personal Data</PageSubTitle>
        <PageSuperSubTitle>Types of Data Collected</PageSuperSubTitle>
        <h4>Personal Data</h4>
        <p>
        ...
        <PageSuperSubTitle>Use of Your Personal Data</PageSuperSubTitle>
        ...
        <PageSuperSubTitle>Retention of Your Personal Data</PageSuperSubTitle>
        <p>
        ...
        <PageSuperSubTitle>Transfer of Your Personal Data</PageSuperSubTitle>
        <p>
          {
        ...
        <p>
          ...
          Policy and no transfer of Your Personal Data will take place to an organization or a country unless there are
          adequate controls in place including the security of Your data and other personal information.
        </p>
        <PageSuperSubTitle>Delete Your Personal Data</PageSuperSubTitle>
        <p>
        ...
        <PageSuperSubTitle>Disclosure of Your Personal Data</PageSuperSubTitle>
        ...
        <PageSuperSubTitle>Security of Your Personal Data</PageSuperSubTitle>
        <p>
        ...
        <PageSubTitle>{"Children's Privacy"}</PageSubTitle>
        <p>
        ...
        <PageSubTitle>Links to Other Websites</PageSubTitle>
        <p>
          {
        ...
        <PageSubTitle>Changes to this Privacy Policy</PageSubTitle>
        <p>
        ...
        <PageSubTitle>Contact Us</PageSubTitle>
        <p>If you have any questions about this Privacy Policy, You can contact us:</p>
        <UList>
          <li>By email: office@menime.com</li>
        </UList>
      </div>
    </>
  );
...
const PageTitle = ({
  ...
  return (
    <>
      <h1 className="-mx-4 my-5 border-l-4 border-primary pl-5 text-3xl">{children}</h1>
    </>
  );
};
...
const PageSubTitle = ({
  ...
  return (
    <>
      <h1 className="-mx-4 my-5 border-l-4 border-primary pl-5 text-2xl">{children}</h1>
    </>
  );
};

const PageSuperSubTitle = ({
  children,
}: Readonly<{
  children: React.ReactNode;
}>) => {
